...
void GameScene::Initialize() {
	...
	// 頭
	worldTransform_[PartId::Head].translation_ = {0, 5.0f, 0};
	...
	// 右腕
	worldTransform_[PartId::ArmR].translation_ = {5.0f, 0, 0};
	...
	// 左脚
	worldTransform_[PartId::LegL].translation_ = {-5.0f, -5.0f, 0};
	worldTransform_[PartId::LegL].parent_ = &worldTransform_[PartId::Hip];
	worldTransform_[PartId::LegL].Initialize();
	// 右脚
	worldTransform_[PartId::LegR].translation_ = {5.0f, -5.0f, 0};
